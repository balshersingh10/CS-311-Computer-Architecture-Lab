        ...
        if(IF_OF_Latch.isOF_enable() && !OF_EX_Latch.isEX_busy())
        {
            ...
            if (operation.toString().equals("add")
                ...
                //containingProcessor.getRegisterFile().setProgramCounter(output);
                    ...
                    || operation.toString().equals("store")) {
                rs1 = new Operand();
                rs1.setOperandType(OperandType.Register);
                reg_no = Integer.parseInt(instb.substring(5, 10), 2);
                rs1.setValue(reg_no);
                ...
                instn.setSourceOperand2(rs2);
                instn.setDestinationOperand(rd);
            } else if(operation.toString().equals("addi")
                    || operation.toString().equals("subi")
                    || operation.toString().equals("muli")
                    || operation.toString().equals("divi")
                    || operation.toString().equals("andi")
                    || operation.toString().equals("ori")
                    || operation.toString().equals("xori")
                    || operation.toString().equals("slti")
                    || operation.toString().equals("slli")
                    || operation.toString().equals("srli")
                    || operation.toString().equals("srai")
                    || operation.toString().equals("load")){
                // Source register 1
                rs1 = new Operand();
                rs1.setOperandType(OperandType.Register);
                reg_no = Integer.parseInt(instb.substring(5, 10), 2);
